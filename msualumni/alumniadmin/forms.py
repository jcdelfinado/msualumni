...
class FiltersForm(forms.Form):
  ...
  class_year = forms.IntegerField(required=False, label="", min_value=1963, max_value=9999, widget=forms.NumberInput(attrs={'disabled':'', 'name':'grad__year', 'placeholder':'Class Year', 'type':'number', 'class':'input-sm advanced'}))
